...
import random
from .models import Question,Kanmusu,Seiyu,Kansyu,Oogata,Sanka_kanmusu,Kansyu_setumei,Battle,Ivent,Ivent_naiyou,Tokkokanmusu,Comment
...
def like(request, *args, **kwargs):
    ...
    return redirect('question',pk=q_pk) #'  'はurls.pyのnameの部分を入力
# return HttpResponseRedirect(reverse_lazy('polls:like', kwargs={'answer_id': kwargs['answer_id']}))

#,kwargs={'answer_id': kwargs['answer_id']})353の後ろにあった